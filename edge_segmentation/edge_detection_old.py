...
def main():
    IM_SIZE = 400
    content = io.imread('../paper_images/Tuebingen_Neckarfront.jpg') / 255.0
    ...
    chull_watershed = chull * watershed_edges_bin[:chull.shape[0], :chull.shape[1]]

    show_images(
        [content, chull, watershed_edges_bin, chull_watershed],
        ["content", "convex hull filling", "watershed on edges binaraized", "multipling watershed and convex hull"]
    )
