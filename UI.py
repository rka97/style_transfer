...
class UI(object):
    ...
    def setupUi(self):
        ...
        self.frame.setMaximumSize(QtCore.QSize(400, 23))
        self.frame.setObjectName("frame")
        self.gridLayout.addWidget(self.frame, 1, 0, 1, 1)

        self.mask_c_input = QtWidgets.QLineEdit(self.frame)
        self.mask_c_input.setMaximumWidth(90)
        self.mask_c_input.setGeometry(QtCore.QRect(5, 0, 90, 23))
        self.mask_c_input.setAlignment(QtCore.Qt.AlignCenter)
        self.mask_c_input.setObjectName("mask_c_input")

        self.padding_mode_combo = QtWidgets.QComboBox(self.frame)
        self.padding_mode_combo.setGeometry(QtCore.QRect(105, 0, 90, 23))
        self.padding_mode_combo.setObjectName("padding_mode_combo")
        self.padding_mode_combo.addItems(["constant", "edge", "wrap"])

        self.sigma_s_input = QtWidgets.QLineEdit(self.frame)
        self.sigma_s_input.setMaximumWidth(90)
        self.sigma_s_input.setGeometry(QtCore.QRect(205, 0, 90, 23))
        self.sigma_s_input.setAlignment(QtCore.Qt.AlignCenter)
        self.sigma_s_input.setObjectName("sigma_s_input")

        self.sigma_r_input = QtWidgets.QLineEdit(self.frame)
        self.sigma_r_input.setMaximumWidth(90)
        self.sigma_r_input.setGeometry(QtCore.QRect(305, 0, 90, 23))
        self.sigma_r_input.setAlignment(QtCore.Qt.AlignCenter)
        self.sigma_r_input.setObjectName("sigma_r_input")
        ...
        self.cv_ethreshold_input.setGeometry(QtCore.QRect(70, 25, 240, 23))
        ...
        self.cv_mu_input.setGeometry(QtCore.QRect(70, 55, 240, 23))
        ...
        self.cv_lamda_1_imput.setGeometry(QtCore.QRect(70, 85, 240, 23))
        ...
        self.cv_lamda_2_imput.setGeometry(QtCore.QRect(70, 115, 240, 23))
        ...
        self.cv_tol_input.setGeometry(QtCore.QRect(70, 145, 240, 23))
        ...
        self.cv_max_iter_input.setGeometry(QtCore.QRect(70, 175, 240, 23))
        ...
        self.cv_dt_input.setGeometry(QtCore.QRect(70, 205, 240, 23))
        ...
        self.cv_init_level_set_combo.setGeometry(QtCore.QRect(70, 235, 240, 23))
        ...
        self.edge_coherance_input = QtWidgets.QLineEdit(self.edge_segmentation_page)
        self.edge_coherance_input.setGeometry(QtCore.QRect(200, 10, 160, 23))
        self.edge_coherance_input.setAlignment(QtCore.Qt.AlignCenter)
        self.edge_coherance_input.setObjectName("edge_coherance_input")
    ...
    def retranslateUi(self):
        ...
        self.sigma_s_input.setPlaceholderText(_translate("self.window", "sigma_s"))
        self.sigma_r_input.setPlaceholderText(_translate("self.window", "sigma_r"))
        ...
        self.edge_strength_input.setPlaceholderText(_translate("self.window", "strengh threshold"))
        self.edge_coherance_input.setPlaceholderText(_translate("self.window", "coherance threshold"))
